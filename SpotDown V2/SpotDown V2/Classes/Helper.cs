...
namespace SpotDown_V2.Classes
{
    public class Helper
    {
        ...
        /// </summary>
        public string GetTxtBtwn(string input, string start, string end, int startIndex)
        {
        ...
        /// Gets the txt that lies between these two strings
        /// </summary>
        public string GetLastTxtBtwn(string input, string start, string end, int startIndex)
        {
        ...
        /// Gets the txt that lies between these two strings
        /// </summary>
        private string GetTxtBtwn(string input, string start, string end, int startIndex, bool UseLastIndexOf)
        {
        ...
        /// </summary>
        public string[] Split(string input, string pattren)
        {
